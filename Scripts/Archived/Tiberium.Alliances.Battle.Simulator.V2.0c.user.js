...
// @version     1.19.5
// @author      Eistee, TheStriker, VisiG
// @contributor zbluebugz (https://github.com/zbluebugz)
// @grant       none
// @license     CC BY-NC-ND 3.0 - http://creativecommons.org/licenses/by-nc-nd/3.0/
//
// Original source of the V2 simulator: https://github.com/Eistee82/ta_simv2
// The script below was extracted from Crucial Pack All in One by DebitoSphere with some adaptions to the original source's code.
//
// v1.19.5 : December 2019; zbluebugz; Fixes applied due to EA's December 2019 game patch/updates release 19.5
//           Source of fix: https://forums.ea.com/en/commandandconquer/discussion/253167/tiberium-alliances-battle-simulator-v2-update-19-5
//           Updated cncopt.com code - additional parameters and changed website to cnctaopt.com (non-flash).
//
// ==/UserScript==
    ...
    function createClasses() {
      ...
      qx.Class.define("TABS.RES.IMG", {							// [static]		Ressources: Images
        ...
        statics: {
          ...
          CNCOpt: "http://www.cnctaopt.com/favicon.ico"   // point to cnctaopt.com (non-flash)
        }
      });
      ...
      qx.Class.define("TABS.UTIL.CNCOpt", {						// [static]		CNCOpt  / CNCTAOpt (non flash)
        type: "static",
        statics: {
          keymap: {
            "GDI_Accumulator": "a",
          ...
          createLink: function (city, own_city) {
            ...
            // change site from cncopt.com (flash) to cnctaopt.com (non-flash)
            link = link.replace( "cncopt.com", "cnctaopt.com") ;
            // cnctaopt.com uses tilde - not vertical bar as separator.
            //link = link.replace("|","~")
            return link ;
          },
...
*/
      ...
      qx.Class.define("TABS.GUI.PlayArea", {						// [singleton]	View Simulation, Open Stats Window
        ...
        construct: function () {
          try {
            ...
            this.boxMove.add(this.newButton(TABS.RES.IMG.CNCOpt, this.tr("Show current formation with CNCTAOpt") + " [NUM 9]<br>" + this.tr("Right click: Set formation from CNCTAOpt Long Link") + "<br>" + this.tr("Remember transported units are not supported."), this.onClick_CNCOpt, null, null), {
              row: 0,
              column: 2
            });
        ...
        members: {
          ...
          onClick_CNCOpt: function (e) {
            if (e.isRightPressed())
              TABS.UTIL.Formation.Set(TABS.UTIL.CNCOpt.parseLink(prompt(this.tr("Enter CNCTAOpt Long Link:"))));
            else
    ...
    function translation() {
      ...
      localeManager.addTranslation("de", {
        ...
        "Show current formation with CNCTAOpt": "Zeigt die aktuelle Formation mit CNCTAOpt an", //GUI.PlayArea
        "Right click: Set formation from CNCTAOpt Long Link": "Rechtsklick: Formation von CNCTAOpt Long Link laden", //GUI.PlayArea
        ...
        "Enter CNCTAOpt Long Link:": "CNCTAOpt Long Link eingeben:", //GUI.PlayArea
