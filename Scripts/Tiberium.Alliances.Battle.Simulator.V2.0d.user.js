// ==UserScript==
// @name        CnC TA: Tiberium Alliances Battle Simulator V2.0d - Standalone
...
//           changed cncopt.com code block to cnctaopt.com code block.
//
// ==/UserScript==
            ...
            qx.Class.define("TABS.GUI.PlayArea", {						// [singleton]	View Simulation, Open Stats Window
                ...
                construct: function () {
                    try {
                        ...
                        this.boxMove.add(this.newButton(TABS.RES.IMG.CNCTAOpt, this.tr("Show current formation with CNCTAOpt") + " [NUM 9]<br>" + this.tr("Right click: Set formation from CNCTAOpt Long Link") + "<br>" + this.tr("Remember transported units are not supported."), this.onClick_CNCOpt, null, null), {
                            row: 0,
                            column: 2
                        });
                ...
                members: {
                    ...
                    onClick_CNCOpt: function (e) {
                        if (e.isRightPressed())
                            TABS.UTIL.Formation.Set(TABS.UTIL.CNCTAOpt.parseLink(prompt(this.tr("Enter CNCTAOpt Long Link:"))));
                        else
                            qx.core.Init.getApplication().showExternal(TABS.UTIL.CNCTAOpt.createLink());
                    }
                },
                defer: function () {
